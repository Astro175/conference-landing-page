      ...
      <>
        ...
        <form class="form-floating" onSubmit={handleSubmit}>
          <div class='container'>
            ...
            <select class="form-select" aria-label="Default select example" value={formData.interest} onChange={handleChange}>
            ...
            <div class="form-check">
              <input class="form-check-input" type="checkbox" value={formData.certificate} id="flexCheckDefault"/>
              <label class="form-check-label" for="flexCheckDefault">I want a certificate</label>
            </div>
            <div class="form-check">
              <input class="form-check-input" type="checkbox" value="" id="flexCheckChecked" checked/>
              <label class="form-check-label" for="flexCheckChecked">I don't need a certificate</label>
            </div>
          </div>
        </form>  
      </>
